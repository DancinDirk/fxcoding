...
int OnInit()
  {
   ...
   ObjectDelete(0,"Lots_Sell_"+Symbol());
   ObjectDelete(0,"Lots_Buy_"+Symbol());
   ObjectDelete(0,"Average_Price_Line_"+Symbol());
   ObjectDelete(0,"Trading_Direction_"+Symbol());
   ObjectDelete(0,"Note2_"+Symbol());
...
int OnCalculate(const int rates_total,
                ...
                const double &close[])
  {
   ...
   CreateLabel("Lots_Sell_"+Symbol(),StringFormat("Sell Lots: %.2f",Lots_Sell), 0, 300, 80, clrRed);
   CreateLabel("Lots_Buy_"+Symbol(),StringFormat("Buy Lots: %.2f",Lots_Buy), 0, 300, 110, clrLime);
   ObjectCreate(0,"Average_Price_Line_"+Symbol(),OBJ_TREND,0,Average_Price);
...
void CreateLabel(string name, string text, int corner, int x_dist, int y_dist, color clr)
  {
   ObjectCreate(0, name, OBJ_LABEL, 0, 0);
